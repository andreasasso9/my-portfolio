export default function Contact() {
  return (
	<div className="flex flex-col items-center justify-center mt-10 px-20 pb-20 text-xl">
		...
		<div className="mt-10">
			<p>Email: <a href="mailto:andry-sasso@outlook.it"className="text-blue-500 hover:underline">andry-sasso@outlook.it</a></p>
			<p className="mt-2">LinkedIn: <a href="https://www.linkedin.com/in/andrea-sasso-82b5b9371/" className="text-blue-500 hover:underline">Andrea Sasso</a></p>
		</div>
	</div>
  );
}